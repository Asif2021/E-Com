...
const Page = () => {
  ...
  return (
    <>
      <form 
        action={handleSubmit} 
        className="space-y-3 max-w-[450px] mx-auto flex-1 rounded-lg border border-gray-300 shadow-2xl p-8 mt-0 md:mt-10"
      >
        ...
        <button
          ...
          className={`text-white uppercase font-medium rounded-lg text-medium w-full sm:w-auto px-5 py-2.5 text-center ${
            isSubmitting 
